...
class OfflineOrchestrator(Orchestrator):
    def __init__(self, model: BaseRLModel, train_samples, eval_prompts, reward_fn, stats_fn=None):
        self.model = model
        ...
        self.model.train_store = OfflineRolloutStorage(train_samples, attention_mask, rewards)
