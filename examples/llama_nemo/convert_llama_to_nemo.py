...
def main():
    print("loading model...")
    model = AutoModelForCausalLM.from_pretrained("/mnt/hdd/llama-hf/65B")
    ...
    OUTPUT_FOLDER = "llama-nemo-65b-tp4-out"  # NeMo converted checkpoint folder with llama weights
    ...
    OmegaConf.save(megatron_cfg, str(Path(OUTPUT_FOLDER) / "megatron_65b_llama.yaml"))
