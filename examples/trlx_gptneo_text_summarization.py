...
if __name__ == "__main__":
    ...
    rw_model.load_state_dict(torch.load("/fsx/home-duyphung/sandbox/refactor_summarize_rlhf/trlx/examples/summarize_rlhf/reward_model_inspect/ckpts/openai_comparison_summary/gpt-j/checkpoint-1700/pytorch_model.bin"))
    rw_model.half()
    rw_model.eval()
