...
def main(hparams={}):
    ...
    if cfg_name == "1.3B":
        ...
        nemo_config.name = "megatron_gpt_30b"
        ...
        nemo_config.trainer.num_nodes = 4
        nemo_config.trainer.devices = 8
        nemo_config.model.num_layers = 80
        nemo_config.model.hidden_size = 8192
        nemo_config.model.ffn_hidden_size = 22016
        nemo_config.model.num_attention_heads = 64

        nemo_config.model.tensor_model_parallel_size = 8
        nemo_config.model.pipeline_model_parallel_size = 2
        batch_size = 16
        mini_batch_size = 1
        chunk_size = 4
    else:
